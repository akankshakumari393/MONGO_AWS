 ...
 * 
 * import static org.mockito.BDDMockito.*; import static
 ...
 * 
 * import com.gslab.mongo5.exception.ProjectNotFoundException; import
 * com.gslab.mongo5.model.Project; import
 * com.gslab.mongo5.repository.ProjectRepository; import
 * com.gslab.mongo5.service.ProjectService;
 * 
 * @RunWith(MockitoJUnitRunner.class) public class ProjectServiceTest {
 * 
 * @Mock private ProjectRepository projectRepository;
 * 
 * private ProjectService projectService;
 * 
 * @Before public void setUp() throws Exception { projectService = new
 * ProjectService(projectRepository); }
 * 
 * @Test public void getProject_returnProject() { Optional<Project> p =
 * Optional.of(new Project("2","hello"));
 ...
 * 
 * @Test( expected = ProjectNotFoundException.class) public void
 * getProject_whenCarNotFound() { //Optional<Project> p = Optional.of(new
 * Project("2","hello"));
 ...
 * }
 * 
 * @Test public void addProject() { Project savedProject = new
 * Project("2","project2");
 ...
 * 
 * @Test public void deleteProject() {
 * doNothing().when(projectRepository).deleteByid(anyString());
 * projectRepository.deleteByid("5"); verify(projectRepository,
 * times(1)).deleteByid("5"); } }
 */