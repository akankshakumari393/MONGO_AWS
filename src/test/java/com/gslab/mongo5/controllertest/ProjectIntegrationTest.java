...
import com.gslab.mongo5.Mongo5Application;
import com.gslab.mongo5.assembler.ProjectResourceAssembler;
import com.gslab.mongo5.model.Project;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = Mongo5Application.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
...
public class ProjectIntegrationTest {
	...
	public void before() {
	  ...
	  //Project project = new Project("1", "Project1"); 
		  HttpEntity<Project> entity= new HttpEntity<Project>(null, headers); System.out.
	...
	@Test
	public void addProject() throws RestClientException, URISyntaxException {
		...
		ResponseEntity<Project> response = restTemplate.exchange(
				new URI("http://localhost:" + port + "/mongo-api/projects"), HttpMethod.POST, entity, Project.class);
		System.out.println(" --------------------------------------------------------Printing response value ");
