 ...
 * com.gslab.mongo5.assembler.EmployeeResourceAssembler; import
 * com.gslab.mongo5.assembler.ProjectResourceAssembler; import
 * com.gslab.mongo5.controller.ProjectController; import
 * com.gslab.mongo5.exception.ProjectNotFoundException; import
 * com.gslab.mongo5.model.Project; import
 * com.gslab.mongo5.service.ProjectService;
 * 
 ...
 * 
 * 
 * @Test public void getProject_shouldReturnProject() throws Exception{
 * 
 * //System.out.println("Starting get Project Test that should return a project"
 * ); given(projectService.getProject("5")).willReturn(new
 * Project("5","project5"));
 * //System.out.println("Found going to perform the test");
 * mockMvc.perform(MockMvcRequestBuilders .get("/mongo-api/projects/5"))
 ...
 * 
 * @Test public void getProject_IfNotFound() throws Exception{ //System.out.
 * println("Starting get Project Test that should not return a project");
 * given(projectService.getProject(anyString())).willThrow(new
 * ProjectNotFoundException(anyString()));
 * //System.out.println("Not found going to perform the test");
 * mockMvc.perform(MockMvcRequestBuilders .get("/mongo-api/projects/1"))
 * .andExpect(status().isNotFound());
 * //System.out.println(" Not found testing done"); }
 * 
 * @Test public void newProject() throws Exception{
 * //System.out.println("Starting get Project Test that should add a project");
 * Project p1 = new Project("1", "abc"); Project p2 = new Project("2", "abcd");
 * given(projectService.addProject(any(Project.class))).willReturn(p1);
 * //System.out.println("adding going to perform the test");
 * mockMvc.perform(MockMvcRequestBuilders .post("/mongo-api/projects")
 * .content(asJsonString(p2)) .contentType(MediaType.APPLICATION_JSON)
 ...
 * }
 * 
 * @Test public void deleteProject() throws Exception{ System.out.
 * println("Starting delete Project Test that should delete a project");
 * doNothing().when(projectService).deleteProject("5");
 * projectService.deleteProject("5"); verify(projectService,
 * times(1)).deleteProject("5");
 * System.out.println("adding going to perform the test");
 * mockMvc.perform(MockMvcRequestBuilders .post("/mongo-api/projects")
 * .content(asJsonString(p2)) .contentType(MediaType.APPLICATION_JSON)
 * .accept(MediaType.APPLICATION_JSON))
